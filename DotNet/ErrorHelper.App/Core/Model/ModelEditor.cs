...
namespace ErrorHelper.App.Core.Model
{
    ...
    public abstract class ModelEditor
    {
        ...
        private System.Windows.Forms.Control? GetEditControl(List<PropertyEditor> propertyEditorList, string propName)
        {
        ...
        public PropertyEditor(PropertyInfo prop)
        {
            ...
            if (prop.PropertyType == typeof(string))
            {
                if (PropertyName.EndsWith("FolderPath"))
                {
                    ...
                    {
                        EditControl.Text = FormControlService.GetSelectFolderPath(EditControl.Text);
                    };
                }
                else if (PropertyName.EndsWith("Path"))
                {
                    ...
                    SelectButton.Click += (sender, e) =>
                    {
                        EditControl.Text = FormControlService.GetSelectFilePath(EditControl.Text);
                    };
                }
            }
        }
